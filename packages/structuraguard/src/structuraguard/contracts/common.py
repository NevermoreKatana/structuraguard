...
class BuiltInErrorCode(StrEnum):
    ...
    STRUCTURE_INPUT_INVALID = "STRUCTURE_INPUT_INVALID"
    PARSE_PLAN_UNSUPPORTED = "PARSE_PLAN_UNSUPPORTED"
    PARSE_PLAN_SOURCE_MISMATCH = "PARSE_PLAN_SOURCE_MISMATCH"
    PARSE_PLAN_REPLAY_REQUIRED = "PARSE_PLAN_REPLAY_REQUIRED"
    PARSE_EXECUTION_MISMATCH = "PARSE_EXECUTION_MISMATCH"
    PARSE_EXECUTION_SOURCE_ERROR = "PARSE_EXECUTION_SOURCE_ERROR"
